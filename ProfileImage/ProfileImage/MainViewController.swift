...
class MainViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func populateControllersArray() {
        ...
        controller = storyboard!.instantiateViewController(withIdentifier: "HexagonProfileImage") as! HexagonProfileImageViewController
        controller.itemIndex = 1
        controller.view.backgroundColor = UIColor.clear
        _controllers.append(controller)
        
        controller = storyboard!.instantiateViewController(withIdentifier: "SquareProfileImage") as! SquareProfileImageViewController
        controller.itemIndex = 2
        controller.view.backgroundColor = UIColor.clear
        _controllers.append(controller)
        
        controller = storyboard!.instantiateViewController(withIdentifier: "RoundProfileImage") as! RoundProfileImageViewController
